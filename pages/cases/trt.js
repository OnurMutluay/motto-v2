...
const Lipton = () => {
    return (
        <Fragment>
            <CaseDetailHeader url="/trt/header.jpg" title="GASTRONOMETRO" />
            ...
            <CaseDetailGrid grid={2} images={['/trt/1.png', '/trt/2.png']} />
            <CaseDetailGrid grid={2} images={['/trt/3.png', '/trt/4.png']} />

            <CaseDetailGrid grid={3} images={['/trt/5.png', '/trt/6.png', '/trt/7.png']} />
            ...
            <CaseDetailGrid grid={2} images={['/trt/8.png', '/trt/9.png']} />
