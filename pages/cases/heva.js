...
const Lipton = () => {
    return (
        <Fragment>
            <CaseDetailHeader url="/heva/header.jpg" title="HEVA" />
            ...
            <CaseDetailGrid grid={2} images={['/heva/1.png', '/heva/2.png']} />
            <CaseDetailGrid grid={2} images={['/heva/3.png', '/heva/4.png']} />

            <CaseDetailGrid grid={3} images={['/heva/5.png', '/heva/6.png', '/heva/7.png']} />
            <CaseDetailDescription
                oneCol={true}
            ...
            />
            <div style={{ backgroundColor: '#DCDDE2' }} className={styles.colorized}>
                <CaseDetailGrid grid={2} images={['/heva/8.png', '/heva/9.png']} />
                <CaseDetailGrid
                    grid={3}
                    images={['/heva/10.png', '/heva/11.png', '/heva/12.png']}
                />
            </div>
